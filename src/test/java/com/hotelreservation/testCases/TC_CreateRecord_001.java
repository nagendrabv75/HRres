...
public class TC_CreateRecord_001 extends BaseClass{
	...
	public void checkOutDate() throws InterruptedException
	{
	        ...
	        date_CO=date_CO+5; //Incrementing by 5 days
	...
	{
		Thread.sleep(5000);
		List <WebElement> deleteRec=driver.findElements(By.xpath("//div[starts-with(@id,'20')]"));
	    int i=2;
